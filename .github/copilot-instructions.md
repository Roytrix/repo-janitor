# Repo Janitor - Copilot Instructions

PRIORITIZE CODEBASE FOR SUGGESTIONS

## Project Overview

Repo Janitor is a GitHub Action that automates repository maintenance tasks using Bash scripts. This action follows strict coding standards and best practices for both GitHub Actions and Bash scripting.
